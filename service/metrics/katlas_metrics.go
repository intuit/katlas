...
var (
	...
	KatlasNumReqErr4xx = promauto.NewCounter(prometheus.CounterOpts{
		Name: "katlas_requests_error_4xx",
	...
	KatlasNumReqErr5xx = promauto.NewCounter(prometheus.CounterOpts{
		Name: "katlas_requests_error_5xx",
